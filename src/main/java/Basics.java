...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        ret.append(word1.charAt(0));
        ret.append(word2.charAt(0));
        ret.append(word3.charAt(0));
        ret.append(word4.charAt(0));
        ret.append(word5.charAt(0));
        ret.append(word6.charAt(0));
        ret.append(word7.charAt(0));
